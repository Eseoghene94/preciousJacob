      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 dark:text-gray-300 mt-4 max-w-2xl mx-auto">
            Let's work together to bring your ideas to life. Feel free to reach
            out for collaborations or just a friendly chat!
          </p>
        </div>
          ...
          >
            <div className="bg-white dark:bg-black p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:precious@example.com"
                      className="text-black dark:text-white hover:text-purple-600 dark:hover:text-teal-400 transition-colors"
                    >
                      blessedpwesh@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-black dark:text-white">Lagos, NIGERIA</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-purple-600 to-teal-500 rounded-lg text-white">
                ...
                <p>
                  Currently available for freelance projects, contract work, and
