...
const Footer: React.FC = () => {
  ...
  const phoneNumber = "+2349033895847"; // Formatted for WhatsApp link
  const displayPhoneNumber = "+234 (903) 389-5847"; // Formatted for display
      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            <a href="#" className="text-2xl font-bold inline-flex items-center">
              <span className="text-purple-500 dark:text-teal-400">
                Precious
              </span>
            ...
            <p className="mt-3 text-gray-300 max-w-md">
              Creating beautiful digital experiences that delight users and
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg
                  className="h-6 w-6 text-teal-400 mr-2 mt-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <a
                  href="mailto:contact@precious.design"
                  className="text-gray-300 hover:text-teal-400 transition-colors"
                >
                  contact@precious.design
                </a>
              </li>
              <li className="flex items-start">
                <svg
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-sm text-gray-400">
            &copy; {currentYear} Precious Jacob. All rights reserved.
          </p>
